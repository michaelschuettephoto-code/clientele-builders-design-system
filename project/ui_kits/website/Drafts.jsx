...
const DRAFTS = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'p', claim: 'A2', text: "The internet is now the number-one resource for life insurance shoppers — across every generation and income level. By the time a prospect reaches a human, they've already formed an opinion. The first impression happened without you in the room." },
      ...
      { type: 'p', claim: 'A3 · A4', text: "The research is blunt here: people decide whether they trust an advisor largely before the first conversation, and trust — not price, not product — is what actually moves them to act. Meanwhile, advisor usage is still low across the board, which means most of the market hasn't engaged anyone yet. The awareness gap is enormous, and it sits right at the top of the funnel." },
